...
func (r *RepositoryAdapter) UpdateFeed(ctx context.Context, feedID int64, title string, url string, iconURL string, fetchInterval time.Duration) error {
	return r.feedRepo.UpdateFeed(ctx, feedID, title, url, iconURL, fetchInterval)
}
